...
export function createSceneStyles(model: ScreenModel, options: RenderSceneOptions): Record<string, IStyle> {
  ...
  return {
    ...
    actionButton: css({ height: dockButtonHeight, marginTop: 7, paddingLeft: 12, paddingRight: 12, flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: PALETTE.yellow, borderWidth: 3, borderColor: PALETTE.ink, borderRightWidth: 7, borderBottomWidth: 7, ':active': { transform: "scale(0.97, 0.97)" } }),
    ...
    orderedCardImage: css({ width: short ? 52 : 64, height: short ? 62 : 80, flexShrink: 0 }),
