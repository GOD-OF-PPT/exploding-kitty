...
export function createSceneStyles(model: ScreenModel, options: RenderSceneOptions): Record<string, IStyle> {
  ...
  const settingsUltraShort = model.id === "settings" && options.height <= 520;
  const longHeaderTitle = model.title.length >= 8;
  const safeTop = model.id === "create" || model.id === "settings"
    ? Math.max(settingsUltraShort ? 20 : short ? 24 : 26, options.safeTop)
  ...
  return {
    ...
    sceneCreate: css({ backgroundColor: "#050404" }),
    sceneSettings: css({ backgroundColor: "#0d0e0d" }),
    ...
    sceneTintInk: css({ backgroundColor: model.id === "create" || model.id === "settings" ? "#0d0e0d" : "rgba(7,7,6,.76)" }),
    ...
    eyebrow: css(model.id === "settings"
      ? { width: 250, height: settingsUltraShort ? 16 : short ? 18 : 22, lineHeight: settingsUltraShort ? 16 : short ? 18 : 22, color: PALETTE.yellow, fontFamily: BODY_FONT, fontSize: settingsUltraShort ? 10 : short ? 10 : 11, fontWeight: "bold", letterSpacing: 1.2, textAlign: "center", textOverflow: "ellipsis", whiteSpace: "nowrap" }
      : { width: titleWidth, height: 20, lineHeight: 20, color: PALETTE.cyan, fontFamily: BODY_FONT, fontSize: 11, fontWeight: "bold", letterSpacing: 1.2, textAlign: "center", textOverflow: "ellipsis", whiteSpace: "nowrap" }),
    ...
    createHeader: css({ width: 390, height: settingsUltraShort ? 82 : short ? Math.max(76, 116 - safeTop) : compact ? Math.max(90, 126 - safeTop) : Math.max(118, 168 - safeTop), paddingLeft: 16, paddingRight: 16, flexShrink: 0, flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between" }),
    createBack: css({ width: settingsUltraShort ? 44 : short ? 46 : 48, height: settingsUltraShort ? 44 : short ? 46 : 48, marginTop: settingsUltraShort ? 2 : short ? 4 : compact ? 6 : 10, flexShrink: 0, flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: "#141412", borderWidth: 2, borderColor: PALETTE.cream, borderRadius: 6, ':active': { transform: "scale(0.95, 0.95)" } }),
    createBackIcon: css({ width: settingsUltraShort ? 24 : short ? 25 : 27, height: settingsUltraShort ? 24 : short ? 25 : 27 }),
    createHeaderCopy: css({ position: "relative", width: 262, height: settingsUltraShort ? 82 : short ? 88 : compact ? 100 : 132, paddingTop: settingsUltraShort ? 6 : short ? 12 : compact ? 15 : 27, flexShrink: 0, flexDirection: "column", alignItems: "center" }),
    createHeaderAccent: css({ position: "absolute", left: settingsUltraShort ? 6 : short ? 6 : compact ? 1 : -9, top: settingsUltraShort ? 25 : short ? 32 : compact ? 36 : 48, width: settingsUltraShort ? 250 : short ? 250 : compact ? 260 : 280, height: settingsUltraShort ? 47 : short ? 49 : compact ? 51 : 55 }),
    ...
    createHeaderSpacer: css({ width: settingsUltraShort ? 44 : short ? 46 : 48, height: settingsUltraShort ? 44 : short ? 46 : 48, flexShrink: 0 }),
    ...
    createScroll: css({ width: 390, height: options.height, flexShrink: 0 }),
    createCanvas: css({ position: "relative", width: 390, height: 844, flexShrink: 0 }),
    createArtboard: css({ position: "absolute", left: 0, top: 0, width: 390, height: 844, imageType: "simple" }),
    createHot: css({ position: "absolute", borderWidth: 0, backgroundColor: "rgba(0, 0, 0, 0)", ':active': { backgroundColor: "rgba(255, 255, 255, 0.14)" } }),
    createHotDisabled: css({ backgroundColor: "rgba(82, 74, 61, 0.44)", ':active': { backgroundColor: "rgba(82, 74, 61, 0.44)" } }),
    createBackHot: css({ left: 16, top: 35, width: 49, height: 48, borderRadius: 7 }),
    createRowHit: css({ position: "absolute", width: 0, height: 0, opacity: 0 }),
    createPlayerDown: css({ left: 20, top: 332, width: 50, height: 57, borderRadius: 8 }),
    createPlayerUp: css({ left: 137, top: 332, width: 50, height: 57, borderRadius: 8 }),
    createTimerDown: css({ left: 203, top: 332, width: 51, height: 57, borderRadius: 8 }),
    createTimerUp: css({ left: 320, top: 332, width: 51, height: 57, borderRadius: 8 }),
    createBotHot: css({ left: 13, top: 423, width: 365, height: 98 }),
    createRulesHit: css({ position: "absolute", left: 13, top: 535, width: 365, height: 172 }),
    createPrimaryHot: css({ left: 13, top: 728, width: 365, height: 93 }),
    createStatePaperPatch: css({ position: "absolute", height: 68, flexDirection: "row", alignItems: "flex-end", justifyContent: "center", paddingBottom: 4, backgroundColor: "#f6e4be" }),
    createPlayerLargePatch: css({ left: 59, top: 257, width: 107 }),
    createTimerLargePatch: css({ left: 229, top: 257, width: 136 }),
    createStateNumber: css({ height: 58, lineHeight: 58, fontFamily: DISPLAY_FONT, fontSize: 50, fontWeight: "bold", color: "#050505", whiteSpace: "nowrap" }),
    createStateUnit: css({ height: 33, lineHeight: 31, marginLeft: 2, fontFamily: DISPLAY_FONT, fontSize: 17, fontWeight: "bold", color: "#050505", whiteSpace: "nowrap" }),
    createStateCurrent: css({ position: "absolute", top: 337, width: 79, height: 46, lineHeight: 44, textAlign: "center", fontFamily: DISPLAY_FONT, fontSize: 16, fontWeight: "bold", color: PALETTE.cream, backgroundColor: "#050505", whiteSpace: "nowrap" }),
    createPlayerCurrentPatch: css({ left: 64 }),
    createTimerCurrentPatch: css({ left: 249 }),
    createReviewStateRow: css({ position: "absolute", left: 78, width: 232, height: 31, lineHeight: 30, fontFamily: DISPLAY_FONT, fontSize: 14, fontWeight: "bold", color: PALETTE.cream, backgroundColor: "#050505", whiteSpace: "nowrap" }),
    createReviewPlayersPatch: css({ top: 589 }),
    createReviewTimerPatch: css({ top: 626 }),
    createReviewBotsPatch: css({ top: 663 }),
    createBotStatePatch: css({ position: "absolute", left: 224, top: 444, width: 132, height: 61, paddingLeft: 8, paddingTop: 6, backgroundColor: "#f6e4be" }),
    createBotStateToggle: css({ position: "relative", width: 116, height: 49, backgroundColor: "#6f645b", borderWidth: 3, borderColor: "#050505", borderRadius: 26 }),
    createBotStateLabel: css({ position: "absolute", right: 8, top: 8, width: 66, height: 29, lineHeight: 29, textAlign: "center", fontFamily: DISPLAY_FONT, fontSize: 13, fontWeight: "bold", color: PALETTE.cream, whiteSpace: "nowrap" }),
    createBotStateThumb: css({ position: "absolute", left: 5, top: 4, width: 35, height: 35, backgroundColor: "#f7ead0", borderWidth: 3, borderColor: "#050505", borderRadius: 19 }),
    createPrimarySendingShade: css({ position: "absolute", left: 13, top: 728, width: 365, height: 93, flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(5, 5, 5, 0.58)" }),
    createPrimarySendingLabel: css({ width: 330, height: 38, lineHeight: 38, textAlign: "center", fontFamily: DISPLAY_FONT, fontSize: 25, fontWeight: "bold", color: PALETTE.cream, whiteSpace: "nowrap" }),
    createPrimarySendingHint: css({ width: 330, height: 22, lineHeight: 22, textAlign: "center", fontFamily: DISPLAY_FONT, fontSize: 11, fontWeight: "bold", color: PALETTE.cream, whiteSpace: "nowrap" }),
    createPrimaryErrorPatch: css({ position: "absolute", left: 80, top: 786, width: 230, height: 22, lineHeight: 22, textAlign: "center", fontFamily: DISPLAY_FONT, fontSize: 11, fontWeight: "bold", color: "#7e1711", backgroundColor: "#fccc03", whiteSpace: "nowrap" }),
    ...
    settingsHeader: css(settingsUltraShort ? { height: 82, flexShrink: 0 } : { flexShrink: 0 }),
    settingsHeaderCopy: css(settingsUltraShort ? { height: 82, paddingTop: 6, flexShrink: 0 } : { flexShrink: 0 }),
    settingsHeaderTitle: css({ position: "relative", width: 276, height: settingsUltraShort ? 46 : short ? 52 : compact ? 56 : 61, lineHeight: settingsUltraShort ? 43 : short ? 48 : compact ? 52 : 57, color: PALETTE.cream, fontFamily: DISPLAY_FONT, fontSize: settingsUltraShort ? 29 : short ? 31 : compact ? 34 : 38, fontWeight: "bold", textAlign: "center", textStrokeWidth: 2, textStrokeColor: "#050505", whiteSpace: "nowrap" }),
    settingsBody: css({ width: 390, flex: 1, minHeight: 0, paddingLeft: 16, paddingRight: 16, paddingTop: settingsUltraShort ? 0 : short ? 2 : 4, flexDirection: "column" }),
    settingsProfile: css({ ...hardShadow(), width: 358, height: settingsUltraShort ? 52 : short ? 74 : compact ? 82 : 94, minHeight: settingsUltraShort ? 52 : short ? 74 : compact ? 82 : 94, marginTop: 0, marginBottom: settingsUltraShort ? 4 : short ? 8 : 12, paddingLeft: settingsUltraShort ? 6 : short ? 8 : 10, paddingRight: settingsUltraShort ? 6 : short ? 8 : 10, flexDirection: "row", alignItems: "center", backgroundColor: PALETTE.yellow, borderRadius: 2, flexShrink: 0 }),
    settingsAvatar: css({ width: settingsUltraShort ? 44 : short ? 56 : 62, height: settingsUltraShort ? 42 : short ? 52 : 58, marginRight: settingsUltraShort ? 6 : short ? 8 : 10, flexShrink: 0 }),
    settingsCopy: css({ width: settingsUltraShort ? 184 : short ? 166 : 172, minWidth: 0, flexDirection: "column", justifyContent: "center", flexShrink: 0 }),
    settingsProfileKicker: css({ width: short ? 166 : 172, height: short ? 16 : 18, lineHeight: short ? 16 : 18, color: PALETTE.cyanOnPaper, fontFamily: BODY_FONT, fontSize: short ? 10 : 11, fontWeight: "bold", letterSpacing: 1, whiteSpace: "nowrap" }),
    settingsName: css({ width: settingsUltraShort ? 184 : short ? 166 : 172, height: settingsUltraShort ? 24 : short ? 26 : 30, lineHeight: settingsUltraShort ? 23 : short ? 25 : 29, color: PALETTE.ink, fontFamily: DISPLAY_FONT, fontSize: settingsUltraShort ? 17 : short ? 18 : compact ? 20 : 22, fontWeight: "bold", whiteSpace: "nowrap", textOverflow: "ellipsis" }),
    settingsDetail: css({ width: settingsUltraShort ? 184 : short ? 166 : 172, height: settingsUltraShort ? 18 : short ? 18 : 21, lineHeight: settingsUltraShort ? 18 : short ? 18 : 20, color: PALETTE.mutedOnLight, fontFamily: BODY_FONT, fontSize: 12, whiteSpace: "nowrap" }),
    settingsProfileBadge: css({ width: settingsUltraShort ? 78 : short ? 84 : 88, height: settingsUltraShort ? 40 : short ? 42 : 46, marginLeft: settingsUltraShort ? 2 : 4, paddingLeft: 5, paddingRight: 5, flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: PALETTE.cyan, borderWidth: 3, borderColor: PALETTE.ink, flexShrink: 0 }),
    settingsProfileBadgeIcon: css({ width: settingsUltraShort ? 16 : short ? 17 : 19, height: settingsUltraShort ? 16 : short ? 17 : 19, marginRight: 4, flexShrink: 0 }),
    settingsProfileBadgeText: css({ width: settingsUltraShort ? 43 : short ? 48 : 51, height: 22, lineHeight: 22, color: PALETTE.ink, fontFamily: BODY_FONT, fontSize: settingsUltraShort ? 10 : short ? 10.5 : 11, fontWeight: "bold", textAlign: "center", whiteSpace: "nowrap" }),
    settingsControlList: css({ width: 358, paddingTop: 0, paddingBottom: short ? 2 : 6, flexDirection: "column", flexShrink: 0 }),
    settingsControl: css({ width: 358, height: settingsUltraShort ? 60 : short ? 88 : compact ? 98 : 110, minHeight: settingsUltraShort ? 60 : short ? 88 : compact ? 98 : 110, marginLeft: 0, marginBottom: settingsUltraShort ? 4 : short ? 8 : 11, paddingLeft: settingsUltraShort ? 6 : short ? 8 : 11, paddingRight: settingsUltraShort ? 6 : short ? 8 : 11, flexDirection: "row", alignItems: "center", backgroundColor: PALETTE.cream, borderWidth: 3, borderColor: "#050505", borderRightWidth: 6, borderBottomWidth: 6, borderRadius: 3, flexShrink: 0 }),
    settingsControlIconBox: css({ width: settingsUltraShort ? 44 : short ? 46 : 52, height: settingsUltraShort ? 44 : short ? 46 : 52, marginRight: settingsUltraShort ? 6 : short ? 8 : 10, padding: settingsUltraShort ? 8 : short ? 9 : 10, alignItems: "center", justifyContent: "center", borderWidth: 3, borderColor: PALETTE.ink, flexShrink: 0 }),
    settingsControlIconSound: css({ backgroundColor: PALETTE.red }),
    settingsControlIconVibration: css({ backgroundColor: PALETTE.cyan }),
    settingsControlIcon: css({ width: settingsUltraShort ? 24 : short ? 23 : 27, height: settingsUltraShort ? 24 : short ? 23 : 27 }),
    settingsControlCopy: css({ width: settingsUltraShort ? 172 : short ? 168 : compact ? 166 : 160, minWidth: 0, flexDirection: "column", justifyContent: "center", flexShrink: 0 }),
    settingsControlTitle: css({ width: settingsUltraShort ? 172 : short ? 168 : compact ? 166 : 160, height: settingsUltraShort ? 23 : short ? 25 : 29, minHeight: settingsUltraShort ? 23 : short ? 25 : 29, lineHeight: settingsUltraShort ? 22 : short ? 24 : 28, color: PALETTE.ink, fontFamily: DISPLAY_FONT, fontSize: settingsUltraShort ? 16 : short ? 17 : compact ? 18 : 20, fontWeight: "bold", whiteSpace: "nowrap" }),
    settingsControlDetail: css({ width: settingsUltraShort ? 172 : short ? 168 : compact ? 166 : 160, height: settingsUltraShort ? 18 : short ? 18 : 20, minHeight: settingsUltraShort ? 18 : short ? 18 : 20, lineHeight: settingsUltraShort ? 18 : short ? 17 : 19, color: PALETTE.mutedOnLight, fontFamily: BODY_FONT, fontSize: 12, whiteSpace: "nowrap" }),
    settingsControlState: css({ width: short ? 168 : compact ? 166 : 160, height: short ? 17 : 19, lineHeight: short ? 17 : 19, color: "#716458", fontFamily: BODY_FONT, fontSize: short ? 11 : 11.5, fontWeight: "bold", whiteSpace: "nowrap" }),
    settingsControlStateOn: css({ color: PALETTE.cyanOnPaper }),
    settingsToggle: css({ width: settingsUltraShort ? 94 : short ? 102 : compact ? 106 : 112, height: settingsUltraShort ? 44 : short ? 46 : compact ? 48 : 50, position: "relative", marginLeft: 0, backgroundColor: "#41392e", borderWidth: 3, borderColor: PALETTE.ink, borderRadius: 26, flexShrink: 0 }),
    settingsToggleOn: css({ backgroundColor: PALETTE.cyan }),
    settingsToggleKnob: css({ position: "absolute", left: 5, top: settingsUltraShort ? 5 : short ? 5 : 6, width: settingsUltraShort ? 28 : short ? 30 : 32, height: settingsUltraShort ? 28 : short ? 30 : 32, backgroundColor: PALETTE.cream, borderWidth: 2, borderColor: PALETTE.ink, borderRadius: 18 }),
    settingsToggleKnobOn: css({ left: settingsUltraShort ? 57 : short ? 64 : compact ? 67 : 72 }),
    settingsToggleLabel: css({ position: "absolute", right: settingsUltraShort ? 10 : short ? 12 : 13, top: settingsUltraShort ? 5 : short ? 6 : 7, width: 32, height: 27, lineHeight: 27, color: PALETTE.cream, fontFamily: BODY_FONT, fontSize: settingsUltraShort ? 10 : short ? 10 : 11, fontWeight: "bold", textAlign: "center" }),
    settingsToggleLabelOn: css({ left: settingsUltraShort ? 12 : short ? 14 : 15, right: 48, color: PALETTE.ink }),
    settingsPrivacy: css({ width: 358, height: settingsUltraShort ? 96 : short ? 116 : compact ? 132 : 150, minHeight: settingsUltraShort ? 96 : short ? 116 : compact ? 132 : 150, marginLeft: 0, marginTop: 0, marginBottom: settingsUltraShort ? 4 : short ? 8 : 12, paddingLeft: settingsUltraShort ? 8 : short ? 10 : 12, paddingRight: settingsUltraShort ? 8 : short ? 10 : 12, paddingTop: settingsUltraShort ? 3 : short ? 7 : 10, paddingBottom: settingsUltraShort ? 3 : short ? 6 : 8, flexDirection: "column", alignItems: "flex-start", backgroundColor: "#0b0b0a", borderWidth: 3, borderColor: "#5d554e", borderRightWidth: 6, borderBottomWidth: 6, borderRadius: 4, flexShrink: 0 }),
    settingsPrivacyHeader: css({ width: settingsUltraShort ? 334 : short ? 328 : 326, height: settingsUltraShort ? 38 : short ? 45 : compact ? 52 : 58, flexDirection: "row", alignItems: "center", flexShrink: 0 }),
    settingsPrivacyIcon: css({ width: settingsUltraShort ? 24 : short ? 27 : 32, height: settingsUltraShort ? 24 : short ? 27 : 32, marginRight: settingsUltraShort ? 8 : short ? 9 : 11, flexShrink: 0 }),
    settingsPrivacyCopy: css({ width: settingsUltraShort ? 300 : short ? 288 : 282, flexDirection: "column" }),
    settingsPrivacyTitle: css({ width: settingsUltraShort ? 300 : short ? 288 : 282, height: settingsUltraShort ? 21 : short ? 23 : 28, lineHeight: settingsUltraShort ? 21 : short ? 23 : 28, color: PALETTE.yellow, fontFamily: DISPLAY_FONT, fontSize: settingsUltraShort ? 13 : short ? 14 : compact ? 15 : 17, fontWeight: "bold", whiteSpace: "nowrap" }),
    settingsPrivacyDetail: css({ width: settingsUltraShort ? 300 : short ? 288 : 282, height: settingsUltraShort ? 17 : short ? 18 : 22, lineHeight: settingsUltraShort ? 17 : short ? 17 : 20, color: PALETTE.mutedOnDark, fontFamily: BODY_FONT, fontSize: settingsUltraShort ? 11 : short ? 11 : 11.5, whiteSpace: "nowrap", textOverflow: "ellipsis" }),
    settingsPrivacyRow: css({ width: settingsUltraShort ? 334 : short ? 328 : 326, height: settingsUltraShort ? 25 : short ? 28 : compact ? 31 : 35, flexDirection: "row", alignItems: "center", borderWidth: 0, borderTopWidth: 1, borderColor: "#3e3933", flexShrink: 0 }),
    settingsPrivacyBullet: css({ width: settingsUltraShort ? 16 : short ? 17 : 20, height: settingsUltraShort ? 16 : short ? 17 : 20, marginLeft: settingsUltraShort ? 3 : short ? 4 : 6, marginRight: settingsUltraShort ? 8 : short ? 9 : 11, flexShrink: 0 }),
    settingsPrivacyText: css({ width: settingsUltraShort ? 304 : short ? 298 : 286, height: settingsUltraShort ? 23 : short ? 25 : compact ? 28 : 31, lineHeight: settingsUltraShort ? 23 : short ? 25 : compact ? 28 : 31, color: PALETTE.cream, fontFamily: DISPLAY_FONT, fontSize: 12, fontWeight: "bold", whiteSpace: "nowrap" }),
    settingsLinks: css({ width: 358, marginTop: 0, flexDirection: "column" }),
    settingsLink: css({ width: 358, minHeight: short ? 58 : 66, marginLeft: 0, backgroundColor: PALETTE.paper, borderRadius: 0 }),
    settingsActionDock: css({ width: 390, height: (settingsUltraShort ? 70 : short ? 96 : compact ? 106 : 130) + safeBottomInset, minHeight: (settingsUltraShort ? 70 : short ? 96 : compact ? 106 : 130) + safeBottomInset, paddingLeft: 16, paddingRight: 16, paddingTop: settingsUltraShort ? 3 : short ? 5 : compact ? 8 : 15, paddingBottom: safeBottomInset, flexDirection: "column", alignItems: "center", justifyContent: "flex-start", flexShrink: 0 }),
    settingsPrimary: css({ position: "relative", width: 358, height: settingsUltraShort ? 64 : short ? 78 : 86, flexShrink: 0, flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(0,0,0,0)", borderWidth: 0, ':active': { transform: "scale(0.98, 0.98)" } }),
    settingsPrimaryBackground: css({ position: "absolute", left: 0, top: 0, width: 358, height: settingsUltraShort ? 64 : short ? 78 : 86 }),
    settingsPrimaryCopy: css({ position: "relative", width: 330, height: settingsUltraShort ? 48 : short ? 56 : 64, flexDirection: "column", alignItems: "center", justifyContent: "center" }),
    settingsPrimaryLabel: css({ width: 330, height: settingsUltraShort ? 30 : short ? 36 : 42, lineHeight: settingsUltraShort ? 29 : short ? 35 : 41, color: "#050505", fontFamily: DISPLAY_FONT, fontSize: settingsUltraShort ? 21 : short ? 23 : compact ? 25 : 27, fontWeight: "bold", textAlign: "center", whiteSpace: "nowrap" }),
    settingsPrimaryHint: css({ width: 330, height: short ? 17 : 18, lineHeight: short ? 17 : 18, color: "#4d4137", fontFamily: BODY_FONT, fontSize: short ? 9.5 : 10.5, fontWeight: "bold", textAlign: "center", whiteSpace: "nowrap" }),
